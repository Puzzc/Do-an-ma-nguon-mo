                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Add Post Category</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-primary">
                                <strong>POST CATEGORY INFORMATION</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="PostCategoryController.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
